...
export function LandingPageHero({ bgScheme, children }: LandingPageHeroProps) {
  return (
    <div
      className="w-full min-h-screen flex justify-center items-center bg-fixed py-10 bg-transparent bg-no-repeat md:bg-right bg-center"
      style={{
        backgroundImage: `${
    ...
    >
      <div className="absolute bottom-0 left-0 overflow-hidden leading-[0]">
        <svg
          data-name="Layer 1"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 1200 120"
          preserveAspectRatio="none"
          className="relative block w-screen h-nav md:h-[150px]"
        >
          <path
